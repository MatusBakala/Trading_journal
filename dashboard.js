...
function renderDashboard(){
  ...
  if(typeof Chart!=='undefined'){
    ...
    eqChartObj=new Chart($('eqChart'),{type:'line',data:{labels,datasets:[{data:eq,borderColor:accentColor,backgroundColor:accentColor+'1f',fill:true,pointRadius:0,tension:.2,borderWidth:2}]},
    ...
    dailyChartObj=new Chart($('dailyChart'),{type:'bar',data:{labels:dkeys.map(k=>k.slice(5)),datasets:[{data:dkeys.map(k=>daily[k]),backgroundColor:dkeys.map(k=>daily[k]>=0?greenColor:redColor)}]},
