...
'Max. obchodov za deň':'Max. trades per day',
...
'Čo si robil so stopom počas obchodu':'What you did with the stop during the trade',
'Stop nikdy neposunutý':'Stop never moved','Posunutý len do zisku':'Moved into profit only','Posunutý do straty':'Moved further into loss',
'Z histórie stop príkazov v Order History. Obchodov s históriou:':'From the stop-order history in Order History. Trades with history:',
'bez histórie (neurčené):':'no history (unknown):',
'Žiadny obchod nemá históriu stop príkazov. Naimportuj Order History z brokera – doplní sa aj spätne k existujúcim obchodom.':'No trade has stop-order history. Import Order History from your broker – it also backfills onto existing trades.',
'Medián R':'Median R','Priemer R':'Mean R','Najhorší':'Worst','Za −2R':'Beyond −2R',
