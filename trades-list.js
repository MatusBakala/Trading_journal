...
function renderTagBarGeneric(elId,filterSet,onChange){
  const el=$(elId);
  if(!el)return;
...
function renderTagBar(){renderTagBarGeneric('tagBar',tagFilter,renderTrades);}
function renderReportTagBar(){renderTagBarGeneric('rTagBar',reportTagFilter,renderReports);}
function applyCommonFilters(list,prefix,filterSet){
